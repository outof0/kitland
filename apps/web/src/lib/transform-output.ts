...
/**
 * Resolve the string shown in a transform result pane.
 *
 * During processing the pane is empty (not the previous value). Invalid and
 * empty sources also clear the pane so invalid→valid recovery cannot flash
 * stale text as current.
 */
