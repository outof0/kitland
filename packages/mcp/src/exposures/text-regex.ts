...
export const kitlandSplitToNewlinesExposure: McpExposure<SplitToNewlinesInput, TextOnlyOutput> = {
  ...
  contractVersion: 1,
  catalogToolId: "split-to-newlines",
