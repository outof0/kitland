...
export const kitlandUnicodeEncodeExposure: McpExposure<TextOnlyInput, TextOnlyOutput> = {
  ...
  contractVersion: 1,
  registryToolId: "unicode-converter",
