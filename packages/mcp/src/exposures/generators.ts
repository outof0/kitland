...
export const kitlandNanoidGenerateExposure: McpExposure<NanoidGenerateInput, NanoidGenerateOutput> =
  {
    ...
    contractVersion: 1,
    catalogToolId: "nanoid-generator",
...
> = {
  ...
  contractVersion: 1,
  catalogToolId: "objectid-generator",
